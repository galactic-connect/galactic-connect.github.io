document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateHeroButton = async () => {
        ...
        const icons = {
            ...
            linux:   '<svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M20 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4V6h16v12zM6.5 9.5l3.5 3.5-3.5 3.5 1.4 1.4 4.9-4.9-4.9-4.9L6.5 9.5zM12 17h5v-2h-5v2z"/></svg>',
        };
