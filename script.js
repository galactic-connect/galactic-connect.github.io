    ...
    const updateHeroButton = () => {
        ...
        if (heroDlBtn && heroDlIcon && heroDlText) {
            ...
            if (/iphone|ipad|ipod/.test(ua)) {
                ...
                link = 'https://github.com/galactic-connect/galactic-connect.github.io/releases/latest/download/galactic-android.apk';
                ...
                // Prefer MSIX as the default Windows distribution.
                link = 'https://github.com/galactic-connect/galactic-connect.github.io/releases/latest/download/galactic-windows.msix';
