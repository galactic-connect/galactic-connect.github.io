document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateHeroButton = async () => {
        ...
        const icons = {
            ...
            linux:   '<svg viewBox="0 0 64 64" width="24" height="24" aria-hidden="true"><path fill="currentColor" d="M32 5.5c-7.1 0-12.4 6.2-12.4 14.8 0 4 1.1 7.6 3 10.2-4.7 3.5-7.7 9.2-7.7 15.7 0 8.6 7.6 12.6 17.1 12.6s17.1-4 17.1-12.6c0-6.5-3-12.2-7.7-15.7 1.9-2.6 3-6.2 3-10.2C44.4 11.7 39.1 5.5 32 5.5z"/><path fill="rgba(255,255,255,.94)" d="M22.9 43.3c0-8 4.1-14.4 9.1-14.4s9.1 6.4 9.1 14.4S37 56.2 32 56.2s-9.1-4.9-9.1-12.9z"/><circle fill="rgba(255,255,255,.94)" cx="27.4" cy="18.6" r="3.3"/><circle fill="rgba(255,255,255,.94)" cx="36.6" cy="18.6" r="3.3"/><circle fill="#06111f" cx="28.2" cy="19.1" r="1.25"/><circle fill="#06111f" cx="35.8" cy="19.1" r="1.25"/><path fill="#ffcc4d" d="M28.3 24.3h7.4L32 28.1zM20.5 54.9c-3.2 2.5-7 3.4-9 1.9-2-1.4-1.1-4.3 2.1-6.8 3.2-2.5 7-3.4 9-1.9 2 1.4 1.1 4.3-2.1 6.8zm23 0c3.2 2.5 7 3.4 9 1.9 2-1.4 1.1-4.3-2.1-6.8-3.2-2.5-7-3.4-9-1.9-2 1.4-1.1 4.3 2.1 6.8z"/><path fill="none" stroke="rgba(0,243,255,.55)" stroke-width="2" stroke-linecap="round" d="M22.2 34.2c-2 2.6-3.2 6.1-3.2 9.9M41.8 34.2c2 2.6 3.2 6.1 3.2 9.9"/></svg>',
        };
